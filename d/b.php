...
<body>
<h1>ฟอร์มสมัครสมาชิก -- ณิชกานต์ พิมพา(ออย)</h1>

<form method="post" action="">

ชื่อ - สกุล <input type="text" name="fullname" required>*<br>
เบอร์โทร<input type="text" name="phone" required>*<br>
ความสูง<input type="number" name="height" step="5" min="100" max="250"  required>ซม.*<br>
