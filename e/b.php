    ...
    <div class="card shadow-lg p-4 p-md-5">
        ...
        <form action="#" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="form-section-title">
                1. ข้อมูลตำแหน่งงานที่ต้องการสมัคร
            </div>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end pt-3">
                <button type="submit" name="Submit" class="btn btn-success btn-lg me-md-2">✅ ยืนยันการสมัคร</button>
...
<?php
    if (isset($_POST['Submit'])){
        ...
        $sql = "INSERT INTO application (a_position, a_prefix, a_name, a_dob, a_phone, a_email, a_education, a_skills, a_experience) VALUES ('{$position}','{$prefix}','{$fullname}','{$dob}','{$phone}','{$email}','{$education}','{$skills}','{$experience}');";
